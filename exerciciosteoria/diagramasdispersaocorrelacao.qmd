...
**Conclua**: Como podemos ver do gráfico, há uma clara tendência de crescimento das temperaturas médias globais. A linha azul é uma linha de regressão apenas para facilitar a visualização da correlação positiva de intensidade moderada entre **Ano** e **Temperatura**.
